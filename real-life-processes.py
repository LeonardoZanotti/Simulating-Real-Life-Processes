...
# https://github.com/LeonardoZanotti/Simulating-Real-Life-Processes
...
NUM_EMPLOYEES = 2
AVG_SUPPORT_TIME = 5        # minutes
CUSTOMER_INTERVAL = 2       # minutes
SIMULATING_TIME = 120       # minutes
...
class CallCenter:
    def __init__(self, env, num_employees, support_time):
        self.env = env
        self.staff = simpy.Resource(env, support_time)
